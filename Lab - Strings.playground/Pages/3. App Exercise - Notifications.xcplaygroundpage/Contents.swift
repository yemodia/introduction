...
let newBest = 15125
let congratulations = "Congratulations \(fullName)! You beat you previous dailiy high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
